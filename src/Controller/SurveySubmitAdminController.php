...
final class SurveySubmitAdminController extends CRUDController
{
    /**
     * @ParamConverter("surveySubmit", class="App\Entity\SurveySubmit")
     */
    ...
    {
        $formBuilder = $this->createFormBuilder($surveySubmit->getSubmittedData());
        $measurementIndex = $surveySubmit->getMeasurementIndex();
